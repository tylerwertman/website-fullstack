  ...
  return (
    <nav className={darkMode ? "navDark" : null}>
      ...
      <div id={darkMode ? "navLinksL" : "navLinksL"}>
        {/* <img src="" alt="" /> */}
        <a className={hoveredElement === 0 ? 'shadowNav' : 'hover'} onMouseEnter={() => { hover(0) }} onMouseLeave={hover} href={darkMode ? "#homeDark" : "#home"}><img src={hoveredElement === 0 ? homeLG : hoveredElement === 0 && darkMode ? homeLG : !darkMode ? homeDSG : homeLG} alt="home" /><span className={hoveredElement === 0 ? 'navLiHover' : 'hidden'}>&nbsp;Home</span></a>&nbsp;
        <a className={hoveredElement === 1 ? 'shadowNav' : 'hover'} onMouseEnter={() => { hover(1) }} onMouseLeave={hover} href={darkMode ? "#aboutDark" : "#about"}><img src={hoveredElement === 1 ? aboutLG : !darkMode ? aboutDSG : aboutLG} alt="about" /><span className={hoveredElement === 1 ? 'navLiHover' : 'hidden'}>&nbsp;About</span></a>&nbsp;
        <a className={hoveredElement === 2 ? 'shadowNav' : 'hover'} onMouseEnter={() => { hover(2) }} onMouseLeave={hover} href={darkMode ? "#projectsDark" : "#projects"}><img src={hoveredElement === 2 ? projectsLG : !darkMode ? projectsDSG : projectsLG} alt="projects" /><span className={hoveredElement === 2 ? 'navLiHover' : 'hidden'}>&nbsp;Projects</span></a>&nbsp;
        <a className={hoveredElement === 3 ? 'shadowNav' : 'hover'} onMouseEnter={() => { hover(3) }} onMouseLeave={hover} href={darkMode ? "#educationDark" : "#education"}><img src={hoveredElement === 3 ? educationLG : !darkMode ? educationDSG : educationLG} alt="education" /><span className={hoveredElement === 3 ? 'navLiHover' : 'hidden'}>&nbsp;Education</span></a>&nbsp;
        <a className={hoveredElement === 4 ? 'shadowNav' : 'hover'} onMouseEnter={() => { hover(4) }} onMouseLeave={hover} href={darkMode ? "#contactDark" : "#contact"}><img src={hoveredElement === 4 ? contactLG : !darkMode ? contactDSG : contactLG} alt="contact" /><span className={hoveredElement === 4 ? 'navLiHover' : 'hidden'}>&nbsp;Contact</span></a>&nbsp;
