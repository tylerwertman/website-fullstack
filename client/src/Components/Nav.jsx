  ...
  return (
    <nav className={darkMode ? "navDark" : null}>
      ...
      <div id={darkMode ? "navLinksL" : "navLinksL"}>
        ...
        <a className={hoveredElement === 2 ? 'shadowNav' : 'hover'} onMouseEnter={() => { hover(2) }} onMouseLeave={hover} href="https://tylerw.xyz#projects"><img src={hoveredElement === 2 ? projectsLG : !darkMode ? projectsDSG : projectsLG} alt="projects" /><span className={hoveredElement === 2 ? 'navLiHover' : 'hidden'}>&nbsp;Projects</span></a>&nbsp;
        <a className={hoveredElement === 3 ? 'shadowNav' : 'hover'} onMouseEnter={() => { hover(3) }} onMouseLeave={hover} href="https://tylerw.xyz#education"><img src={hoveredElement === 3 ? educationLG : !darkMode ? educationDSG : educationLG} alt="education" /><span className={hoveredElement === 3 ? 'navLiHover' : 'hidden'}>&nbsp;Education</span></a>&nbsp;
        <a className={hoveredElement === 4 ? 'shadowNav' : 'hover'} onMouseEnter={() => { hover(4) }} onMouseLeave={hover} href="https://tylerw.xyz#contact"><img src={hoveredElement === 4 ? contactLG : !darkMode ? contactDSG : contactLG} alt="contact" /><span className={hoveredElement === 4 ? 'navLiHover' : 'hidden'}>&nbsp;Contact</span></a>&nbsp;
      ...
      <div id="navLinksSE" className={isNavOpen && darkMode ? "navLinksSEDark" : isNavOpen ? "navLinksSE" : "navLinksSE hide"} onClick={() => { setIsNavOpen(false) }}>
        ...
        <a className={hoveredElement === 2 ? 'shadowNav' : 'hover'} onMouseEnter={() => { hover(2) }} onMouseLeave={hover} href={"https://tylerw.xyz#projects"}><img src={hoveredElement === 2 ? projectsDSG : hoveredElement === 2 && darkMode ? projectsLG : !darkMode ? projectsDSG : projectsLG} alt="projects" /><span className={hoveredElement === 2 ? 'navLiHover' : 'hidden'}></span></a>&nbsp;
        <a className={hoveredElement === 3 ? 'shadowNav' : 'hover'} onMouseEnter={() => { hover(3) }} onMouseLeave={hover} href={"https://tylerw.xyz#education"}><img src={hoveredElement === 3 ? educationDSG : hoveredElement === 3 && darkMode ? educationLG : !darkMode ? educationDSG : educationLG} alt="education" /><span className={hoveredElement === 3 ? 'navLiHover' : 'hidden'}></span></a>&nbsp;
        <a className={hoveredElement === 4 ? 'shadowNav' : 'hover'} onMouseEnter={() => { hover(4) }} onMouseLeave={hover} href={"https://tylerw.xyz#contact"}><img src={hoveredElement === 4 ? contactDSG : hoveredElement === 4 && darkMode ? contactLG : !darkMode ? contactDSG : contactLG} alt="contact" /><span className={hoveredElement === 4 ? 'navLiHover' : 'hidden'}></span></a>&nbsp;
      </div>
    </nav>
  )
}
