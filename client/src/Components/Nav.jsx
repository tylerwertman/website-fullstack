  ...
  return (
    <nav className={darkMode ? "navDark" : "nav"}>
      ...
      <div id="navLinks" className={windowWidth > 625 ? "navLinksL" : isNavOpen && darkMode ? "navLinksSEDark" : isNavOpen ? "navLinksSE" : "navLinksL"} onClick={() => { setIsNavOpen(false) }}>
        ...
        <a className={hoveredElement === 1 ? 'shadowNav' : null} onMouseEnter={() => { hover(1) }} onMouseLeave={hover} href="https://tylerw.xyz#blog"><img src={hoveredElement === 1 ? blogLG : !darkMode ? blogDSG : blogLG} alt="blog" /><span className={hoveredElement === 1 ? 'navLiHover' : 'hidden'}>&nbsp;{windowWidth > 625 ? "Blog" : null}</span></a>
        <a className={hoveredElement === 2 ? 'shadowNav' : null} onMouseEnter={() => { hover(2) }} onMouseLeave={hover} href="https://tylerw.xyz#projects"><img src={hoveredElement === 2 ? projectsLG : !darkMode ? projectsDSG : projectsLG} alt="projects" /><span className={hoveredElement === 2 ? 'navLiHover' : 'hidden'}>&nbsp;{windowWidth > 625 ? "Projects" : null}</span></a>
        <a className={hoveredElement === 3 ? 'shadowNav' : null} onMouseEnter={() => { hover(3) }} onMouseLeave={hover} href="https://tylerw.xyz#education"><img src={hoveredElement === 3 ? educationLG : !darkMode ? educationDSG : educationLG} alt="education" /><span className={hoveredElement === 3 ? 'navLiHover' : 'hidden'}>&nbsp;{windowWidth > 625 ? "Education" : null}</span></a>
        <a className={hoveredElement === 4 ? 'shadowNav' : null} onMouseEnter={() => { hover(4) }} onMouseLeave={hover} href="https://tylerw.xyz#about"><img src={hoveredElement === 4 ? aboutLG : !darkMode ? aboutDSG : aboutLG} alt="about" /><span className={hoveredElement === 4 ? 'navLiHover' : 'hidden'}>&nbsp;{windowWidth > 625 ? "About" : null}</span></a>
        <a className={hoveredElement === 5 ? 'shadowNav' : null} onMouseEnter={() => { hover(5) }} onMouseLeave={hover} href="https://tylerw.xyz#contact"><img src={hoveredElement === 5 ? contactLG : !darkMode ? contactDSG : contactLG} alt="contact" /><span className={hoveredElement === 5 ? 'navLiHover' : 'hidden'}>&nbsp;{windowWidth > 625 ? "Contact" : null}</span></a>
      </div>
