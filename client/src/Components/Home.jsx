        ...
        <div className={darkMode ? "section homeDark" : "section home"} id="home">
            ...
            <div id={darkMode ? "introTwoDark" : "introTwo"}>
                ...
                <div id={darkMode ? "iconsDark" : "icons"}>
                    ...
                    <a href="./files/resume.pdf" download="Tyler Wertman Resume"><img className={hoveredElement === 2 ? "shadow" : null} onMouseEnter={() => { hover(2) }} onMouseOut={hover} src={hoveredElement === 2 ? fileSG : darkMode ? fileLG : fileDSG} alt="file" /></a>
