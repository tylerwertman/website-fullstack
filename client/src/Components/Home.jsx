    ...
    return (
        <div className="section" id="home">
            ...
            <div id="introTwo">
                ...
                <div id="icons">
                    <a href="https://www.linkedin.com/in/tyler-wertman/" target="_blank" rel="noreferrer"><img className={hoveredElement === 0 ? "shadow" : ""} onMouseEnter={()=>{hover(0)}} onMouseOut={hover} src={hoveredElement === 0 ? linkedinH : linkedin} alt="linkedin" /></a>
                    <a href="https://github.com/tylerwertman" target="_blank" rel="noreferrer"><img className={hoveredElement === 1 ? "shadow" : ""} onMouseEnter={()=>{hover(1)}} onMouseOut={hover} src={hoveredElement === 1 ? githubH : github} alt="github" /></a>
                    <a href="./resume.pdf" target="_blank" download="Tyler Wertman Resume"><img className={hoveredElement === 2 ? "shadow" : ""} onMouseEnter={()=>{hover(2)}} onMouseOut={hover} src={hoveredElement === 2 ? fileH : file} alt="file" /></a>
