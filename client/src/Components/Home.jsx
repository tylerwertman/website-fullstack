        ...
        <div className="section" id={darkMode?"homeDark":"home"}>
            ...
            <div id={darkMode?"introTwoDark":"introTwo"}>
                ...
                <div id={darkMode?"iconsDark":"icons"}>
                    <a href="https://www.linkedin.com/in/tyler-wertman/" target="_blank noopener noreferrer" rel="noreferrer"><img className={hoveredElement === 0 ? "shadow" : ""} onMouseEnter={()=>{hover(0)}} onMouseOut={hover} src={hoveredElement === 0 ? linkedinSG : darkMode ? linkedinLG : linkedinDSG} alt="linkedin" /></a>
                    <a href="https://github.com/tylerwertman" target="_blank noopener noreferrer" rel="noreferrer"><img className={hoveredElement === 1 ? "shadow" : ""} onMouseEnter={()=>{hover(1)}} onMouseOut={hover} src={hoveredElement === 1 ? githubSG : darkMode ? githubLG : githubDSG} alt="github" /></a>
                    <a href="./resume.pdf" target="_blank noopener noreferrer" download="Tyler Wertman Resume"><img className={hoveredElement === 2 ? "shadow" : ""} onMouseEnter={()=>{hover(2)}} onMouseOut={hover} src={hoveredElement === 2 ? fileSG : darkMode ? fileLG : fileDSG} alt="file" /></a>
